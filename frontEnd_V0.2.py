...
def displayVendorsWindowSetUp():
    ...
    display_Vendors_ContentTree = ttk.Treeview(root, column=("c1", "c2", "c3", "c4", "c5", "c6"), show='headings')
